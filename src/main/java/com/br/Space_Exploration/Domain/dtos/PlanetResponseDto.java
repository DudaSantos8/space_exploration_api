...
public enum PlanetResponseDto {
    ...
    MARS("Mars", "The Red Planet. Known for its thin atmosphere and potential for future colonization.", 227.9),
    ...
    PlanetResponseDto(String name, String description, double distanceSun) {
        this.name = name;
